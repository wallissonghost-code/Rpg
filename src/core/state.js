...
export const state={
 ...
 camera:{x:0,y:0},input:{x:0,y:0},mobs:[],loot:[],deathBags:[],coins:0,drops:0,inventory:[],equipment:{head:null,body:null,legs:null,feet:null,mystic:null},openBag:null,mapOpen:false,inventoryOpen:false,
