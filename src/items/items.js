...
const HOLD_SECONDS=3;let nearbyBag=null,holding=false,holdTime=0;
...
export function updateItems(dt){
 ...
 holdUI.hidden=!nearbyBag||!!state.openBag||state.mapOpen;
 if(!nearbyBag||state.openBag||state.mapOpen){resetHold();return}
